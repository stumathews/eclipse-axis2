...
/**
 * UserFacadeCallbackHandler.java
 *
 ...
 */
    ...
    /**
     *  UserFacadeCallbackHandler Callback class, Users can extend this class and implement
     *  their own receiveResult and receiveError methods.
     */
    public abstract class UserFacadeCallbackHandler{
    ...
    */
    public UserFacadeCallbackHandler(Object clientData){
    ...
    */
    public UserFacadeCallbackHandler(){
     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultlogout(
                    wsl.UserFacadeStub.LogoutResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultcreateUser(
                    wsl.UserFacadeStub.CreateUserResponse result
                        ) {
           }
